...
const translations: Record<Language, Record<string, string>> = {
  pt: {
    ...
    // Home
    "home.hero.title": "Fintech Builders",
    ...
    "home.about.description": "A Fintech Builders é uma instituição comprometida em transformar o ecossistema financeiro através da tecnologia e inovação. Nossa missão é capacitar profissionais e empresas a construírem soluções financeiras modernas, escaláveis e seguras.",
    ...
    "auth.signup.subtitle": "Junte-se à comunidade Fintech Builders",
  ...
  en: {
    ...
    "home.about.description": "Fintech Builders is an institution committed to transforming the financial ecosystem through technology and innovation. Our mission is to empower professionals and companies to build modern, scalable, and secure financial solutions.",
    ...
    "auth.signup.subtitle": "Join the Fintech Builders community",
